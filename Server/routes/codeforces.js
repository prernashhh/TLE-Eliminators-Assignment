...
// Fetch and sync CF data for a specific student
router.post('/sync/:studentId', async (req, res) => {
  try {
    ...
    // Implement this in a separate utility file for cleaner code
    // Example: const syncResult = await syncStudentCFData(student);
